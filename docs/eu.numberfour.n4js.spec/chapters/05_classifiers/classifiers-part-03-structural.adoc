...
If a type $$T$$ is declared as structural at its definition,
$$T.defStructural$$ is true.
...
6.  A type $$X$$ is a subtype of a structural version of a
type $$\tsStr T$$, if it contains all public, non-static
