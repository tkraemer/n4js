...
strategy modifier_ . Given a type math:[$T$], the simple +++~+++ (tilde)
...
//Requirement
//75Definition Site Structural Typing
...
[[ex:Declaration Site Structural Typing]]
The following snippet demonstrates the effect of definition-site
structural types by comparing them to nominal declared types:
...
[[ex:Effect of structural type modifiers on use-site]]
Let’s assume the type defined on
the left. The following _pseudo_ code snippets explicitly list the type
...
//Requirement
//76Use-Site Structural Typing
[[req:Use_Site_Structural_Typing]]
...
[[req:Definition_and_Use_Site_Precedence]]
...
[[ex:Structural types variable and instanceof operator]]
...
[[ex:Subtype relationship between structural field typing]]
...
// TODO :  review table size in pdf/html, ensure checkmark encoding is ok.
...
.Setters with treated as optional
...
[[ex:Access modifier in structural typing]]
...
//Requirement
//78Additional structural members
...
[[ex:Additional_optional_members_in_structural_typing]]
...
[[ex:Forbidden_additional_structural_members_on_type_variables]]
...
[[ex:Use_explicitly_defined_Interfaces]]
