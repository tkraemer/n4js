...
fragment AsyncNoTrailingLineBreak *: (declaredAsync?='async' NoLineTerminator)?;  // See xref:_asynchronous-functions[Asynchronous Functions].
...
// TODO getter does not effect setter and vice versa
