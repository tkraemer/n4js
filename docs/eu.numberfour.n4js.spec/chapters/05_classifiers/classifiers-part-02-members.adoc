...
//[language=n4bnf,caption={},label={lst:EBNFMember}]
...
// Requirement
// 52Member Names[req:Member_Names]
...
// Requirement
//53Method Definition ECMAScript 6[req:Method Definition ECMAScript 6]
...
// Example
[Final Methods in Interfaces][ex:Final_Methods_in_Interfaces]
...
// Requirement
// 55Type variable names for generic methods[req:Type_variable_names_for_generic_methods]
...
.57 Initialization of Final Fields in the Constructor
...
[[req:Fields_and_constructor_this_type_members]]
...
[[ex:Field_name_conflicts_with_structural_member_name]]
...
[[ex:Anonymous_Interface_in_Constructor]]
...
[[ex:Superfluous_Properties_in_Spec_Style_Constructor]]
...
[[ex:Covariant_Constructors_in_Interfaces]]
...
//Requirement 65
[[req:Static member not abstract]]
...
//Requirement
//67Static Member Access
[[req:Type_Variables_and_Static_Members]]
...
//Requirement
// 68write-access to static data fields and static setter
[[req:write_access_of_static_data_fields]
...
//Requirement
//69Static Members of Interfaces
[[req:StaticMembersOfInterfaces]]
...
[[ex:Static_members_of_interfaces]]
...
70Override Compatible[Override Compatible] A member math:[$M$] is
...
//Requirement
//71Non-Override Declaration
[[req:Non_Override_Declaration]]
...
//Requirement
//72Overriding Members
[[req:Overriding_Members]]
Given a class
...
//Requirement
//73Consumption of Interface Members
[[req:Consumption_of_Interface_Members]]
...
//Requirement
//74Implementation of Interface Members
[[req:Implementation_of_Interface_Members]]
