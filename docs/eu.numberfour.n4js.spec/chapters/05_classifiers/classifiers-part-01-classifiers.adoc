...
<<_final-extensibility,Final Extensibility>>
...
`acc`: ::
Type access modifier as described in <<_accessibility-of-types,Accessibility of types>>, it is the aggregated value of the
...
As specified in <<_defining-and-calling-constructors,Defining and Calling Constructors>>, interfaces
