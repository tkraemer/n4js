...
//Requirement
// 42Subtyping of Classifiers[req:Subtyping_of_Classifiers]
...
//Requirement
//43Structural and Nominal Supertypes[req:Structural_and_Nominal_Super_Types]
...
//Requirement
// 44Implicit Supertype of Classes[req:Implicit_Super_Type_of_Classes]
...
//Requirement
//45Abstract Class[req:Abstract_Class]
...
//Requirement
//46Abstract Member[req:Abstract_Member]
...
47Superclass For a class math:[$C$] with a supertype
...
Besides the general constraints described in , the following constraints
must hold for extending or implementing interfaces:

//Requirement
// 49Extending Interfaces[req:Extending_Interfaces]
For a given type
...
50Implementing Interfaces[req:Implementing_Interfaces] For a given type
...
// Requirement
// 51Definition-Site Variance[req:DefinitionSiteVariance]
