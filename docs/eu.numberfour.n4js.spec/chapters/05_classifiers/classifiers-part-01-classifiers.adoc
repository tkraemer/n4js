...
As specified in <<Req-IDE-56,Defining and calling Constructors,Defining and Calling Constructors>>, interfaces
...
<<_parameterized-types,Parameterized Types>>) or via `typearg` in case of supertypes. If a generic
