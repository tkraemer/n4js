...
[math]
++++
\spc\infer{\tee  lhs\ \lstnfbnf{('<'|'<='|'>'|'>=')}\  rhs\  \expectType\ lhs: T}
        { \tee rhs: T \spc T\in \{\type{number,string,boolean}\}} \\
\spc\infer{\tee  lhs\ \lstnfbnf{('<'|'<='|'>'|'>=')}\  rhs\  \expectType\ lhs: T}
        { \tee rhs: O \spc O \not\in \{\type{number,string,boolean}\} \spc T=\type{\union{number,string,boolean}}  } \\
\spc\infer{\tee  lhs\ \lstnfbnf{('<'|'<='|'>'|'>=')}\  rhs\  \expectType\ rhs: T}
        { \tee lhs: T \spc T\in \{\type{number,string,boolean}\}} \\
\spc\infer{\tee  lhs\ \lstnfbnf{('<'|'<='|'>'|'>=')}\  rhs\  \expectType\ rhs: T}
        { \tee lhs: O \spc O \not\in \{\type{number,string,boolean}\} \spc T=\type{\union{number,string,boolean}}  } \\
++++
