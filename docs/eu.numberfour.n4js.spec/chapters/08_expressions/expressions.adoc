...
//Requirement
//173Valid location for this literal
[[req:ValidLocationForThisLiteral]]
...
//Requirement
//90Type Inference Heuristic for This-Keyword
[[req:Type_Inference_Heuristic_for_This_Keyword]]
...
91Valid Target and Argument for @This
Annotation[req:ValidTargetAndArgumentForThisAnnotation] task:IDE-802[]
...
//Requirement
//92Single @This Annotation
[req:SingleThisAnnotation] task:IDE-802[]
...
95Empty array literal An empty array literal will be inferred as
follows:
...
//Requirement
//97Dot Notation
[[req:Property_Access_And_Dot_Notation]]
...
//Requirement
//99Parameterized Property Access
[[req:Parameterized_Property_Access]]
...
//Requirement
//102Parameterized Function Call Constraints
[[req:Parameterized_Function_Call_Constraints]]
...
//Requirement
//103Postfix Expression Constraints
[[req:PostfixExpressionConstraints]]
...
104delete Operator Constraints[req:DeleteOperatorConstraints] For a
given unary expression math:[$u$] with
...
//Requirement
//105void Operator Constraints
[[req:VoidOperatorConstraints]]
There are no specific constraints defined for with math:[$u.op=\lstnfjs{void}$]
task:IDE-345[]

//Requirement
//106typeof Operator Constraints
[[req:TypeOfOperatorConstraints]]
There are no specific constraints defined for unary expression math:[$u$]
with math:[$u.op=\lstnfjs{typeof}$]. task:IDE-345[]

107Increment/Decrement Constraints[req:IncrementOperatorConstraints] For
a given unary expression math:[$u$] math:[$u$] with
math:[$u.op \in \{++,--\}$] and math:[$u.expression.type: T$],
the following constraints must hold:
...
108Unary Plus/Minus/Bitwise Not Operator
Constraints[req:UnaryPlusOperatorConstraints] For a given unary
expression math:[$u$] math:[$u$] with
...
//Requirement
//109Logical Not Operator Constraints
[[req:NotOperatorConstraints]]
...
111Additive Expression Constraints[req:AdditiveExpressionConstraints]
task:IDE-345[]
...
//Requirement
//112Bitwise Shift Expression Constraints
[[req:BitwiseShiftExpressionConstraints]]
...
//Requirement
//114instanceof Operator Constraints
[[req:instanceofOperatorConstraints]]
...
//Requirement
//115in Operator Constraints
[[req:inOperatorConstraints]] task:IDE-345[]
For a given relational expression math:[$e$] with
...
//Requirement
//116Bitwise Bitwise Expression Constraints
[[req:BitwiseBitwiseExpressionConstraints]]
...
117Binary Logical Expression
Constraints[req:BinaryLogicalExpressionConstraints] For a given binary
logical expression math:[$e$] with math:[$e.lhs.type: L$] and
...
118Conditional Expression
Constraints[req:ConditionalExpressionConstraints] For a given
conditional expression math:[$e$] with math:[\[\begin{aligned}
e.expression.type: C,
...
//TODO: check formatting of last word
...
//Requirement
//122Type Of Super is Always Nominal
[[req:Type_Of_Super_is_Always_Nominal]]
...
//Requirement
//123Access Super Constructor with Super Literal
[req:Access_Super_Constructor_with_Super_Literal]]
...
124Access Super Member with Super
Literal[req:Access_Super_Member_with_Super_Literal] If the super literal
math:[$s$] is used to access a member of the super class, all of
...
//Requirement
//125Super Literal Usage
[[req:Super Literal Usage]]
