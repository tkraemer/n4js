...
what type should be injected into an _injection point_ (<<_n4js-di-injection-points,N4JS DI Injection Points>>) with an expected type.
...
used. Class fields, methods and constructors can be annotated. See <<_n4js-di-injection-points>> for more information.
