...
that of the overridden method, see <<Req-IDE-72,requirement: Overriding Members>> (applies to
method comnsumption and implementation accordingly, see
<<Req-IDE-73,requirement: Consumption of Interface Members>> and
<<Req-IDE-74,requirement: Implementation of Interface Members>>). Note that this is very
...
According to <<Req-IDE-87,requirement: Promisifiable>>, a promisifiable function or method may
