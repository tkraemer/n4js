...
GeneratorFunctionDeclaration <Yield>:
        ...
        'function'
        generator?='*' 
        FunctionHeader<YieldIfGenerator,Generator=true> FunctionBody<Yield=true,Expression>
        FunctionHeader<Yield,Generator=false>
        FunctionBody<Yield=true,Expression=false> Semi
;

GeneratorFunctionExpression:
        generator?='*' NoLineTerminator 'function'
        FunctionHeader<Yield=false,Generator=false>
        FunctionBody<Yield=true,Expression=true>
;

GeneratorArrowExpression <In, Yield>:
