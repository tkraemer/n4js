...
[%hardbreaks]
$ \infer{\type{typeName&lt;T&gt;} \subtype \type{string}}{} \spc  \infer{\type{string} \subtype \type{typeName&lt;T&gt;}}{}$
$ \infer{\type{i18nKey} \subtype \type{string}}{} \spc \infer{\type{string} \subtype \type{i18nKey}}{} $
$ \infer{\type{pathSelector&lt;T&gt;} \subtype \type{string}}{} \spc \infer{\type{string} \subtype \type{pathSelector&gt;T&gt;}}{}$
...
var aub : A|B; // union type
var aib : A&B; // intersection type
...
val fu = aub.f; // typeof{aub.f} = int|string
aub.f = undefined; // typeof{aub.f} = int&string
val fi = aub.f; // typeof{aib.f} = int&string
aub.f = undefined; // typeof{aib.f} = int|string
----
...
The resulting member type depends on whether the member is access during a read (R) or write (W) operation.
...
Field<S>  \| Field<T>   | Field<S>  2+| Getter<S\|T>    | Setter<S&T> |
...
Getter<S>  & Getter<T>  | Getter<S>  || Getter<S&T>     | -            |
Setter<S>  & Setter<T>  || Setter<S>  | -               | Setter<S\|T> |
Field<S>   & Getter<T>  | Field<S>  2+| Getter<S&T>     | Setter<S\|T> |
Field<S>   & Setter<T>  | Field<S>  2+| Getter<S&T>     | Setter<S\|T> |
Getter<S>  & Setter<T>  | Field<S>  2+| Getter<S&T>     | Setter<S\|T> |
|===
