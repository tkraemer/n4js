...
image::userguides/images/ide.png[N4JS IDE, title="N4JS IDE"]
...
image::userguides/images/storage.svg[]
...
image::userguides/images/awaitwarning.png[]

You will also get a lot of other errors in other files:

image::userguides/images/asyncerrors.png[]
...
image::userguides/images/controllertest.svg[]
...
image::userguides/images/createtestproject.png[]
...
image::userguides/images/testinnodejs.png[]

This will run the test and the test view will show the result of the first test:


image::userguides/images/firsttestresults.png[]
...
image::userguides/images/quickfixnpminstall.png[]
...
image::userguides/images/injectionwarning.png[]
...
image::userguides/images/npmexport.png[]
