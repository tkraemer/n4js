 ...
 * {@link eu.numberfour.n4js.tests.issues.IssueExpectations} should be created. Then, new instances of
 * {@link eu.numberfour.n4js.tests.issues.IssueMatcher} should be created using the
 * {@link eu.numberfour.n4js.tests.issues.IssueExpectations#add()} method.
 * <p>
 * Each instance of {@link eu.numberfour.n4js.tests.issues.IssueMatcher} represents an expectation for one particular
