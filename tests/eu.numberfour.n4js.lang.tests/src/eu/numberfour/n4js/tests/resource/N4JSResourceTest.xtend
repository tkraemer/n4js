...
class N4JSResourceTest {
	...
	def void testASTProxy() {
		...
		val supplierResource = rs.createResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js")) as N4JSResource
	...
	def void testLoadFromDescription() {
		...
		val newResource = rs.createResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js")) as N4JSResource
	...
	def void testLoadFromDescriptionFailsIfResourceIsLoaded() {
		var rs = resourceSetProvider.get();
		val supplierResource = rs.getResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js"), true) as N4JSResource
		assertTrue(supplierResource.loaded)
		try {
			supplierResource.loadFromDescription(emptyDescription)
	...
	def void testNoEventsOnLoadFromDescription() {
		val supplierResource = "src/eu/numberfour/n4js/tests/scoping/Supplier.n4js".loadAndResolve
		val resourceDescription = supplierResource.initializedDescription

		val secondResourceSet = resourceSetProvider.get();
		val emptyResource = secondResourceSet.createResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js")) as N4JSResource
	...
	def void testDemandLoadResetsResourceInformation() {
		...
		val secondResourceSet = resourceSetProvider.get();
		val loadedFromDescription = secondResourceSet.createResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js")) as N4JSResource
		val recorder = new RecordingAdapter
	...
	def void testDisposeDocumentDoesntTriggerResolution() {
		val someResource = resourceSetProvider.get.getResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js"), true) as N4JSResource
