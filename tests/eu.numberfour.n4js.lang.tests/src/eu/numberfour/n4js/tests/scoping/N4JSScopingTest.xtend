...
class N4JSScopingTest {
	...
	def void testImportExportAliasedType() {
		...
		val typeClient = '''
			import { Supplier as MySupplier } from "eu.numberfour.n4js/tests/scoping/Supplier";
			var a: MySupplier;
		'''.parse(URI.createURI("TypeClient.js"), rs)
	...
	def void testImportExportN4MemberDeclarationDeserialize() {
		...
		val supplierResource = rs.createResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js"))
		...
		val clientResource = rs.createResource(URI.createURI("src/eu/numberfour/n4js/tests/scoping/Client.n4js"))
	...
	def private void assertElements(IScope scope, String description, String expectationAsString) {
		...
		val defaults = ("Infinity, NaN, constructor, decodeURI, decodeURIComponent, encodeURI, encodeURIComponent, eval, hasOwnProperty, " +
	...
	def void testLocalVariableScoping__NegativeTest() {
		...
		val negativeJS = rs.URIConverter.normalize(
			URI.createURI("src/eu/numberfour/n4js/tests/scoping/negative.n4js"))
