...
class AT_136_AccessPredefinedTypesTest {
	...
	def void test_07() {
		val script = '''
			var b: Boolean = true
		'''.parse
		script.assertError(N4JSPackage.Literals.BOOLEAN_LITERAL, "eu.numberfour.n4js.xsemantics.SubtypeParameterizedTypeRef")
	}
	...
	def void test_09() {
		val script = '''
			var n: Number = 1
		'''.parse
		script.assertError(N4JSPackage.Literals.INT_LITERAL, "eu.numberfour.n4js.xsemantics.SubtypeParameterizedTypeRef")
	}
}
