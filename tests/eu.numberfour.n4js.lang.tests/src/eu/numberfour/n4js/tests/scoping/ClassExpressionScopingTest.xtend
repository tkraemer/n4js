...
class ClassExpressionScopingTest {
	...
	def void testScopingOfNestedN4ClassExpressions() {
		...
		// TODO: fix proxies: same:<eu.numberfour.n4js.ts.model.impl.IdentifiableElementImpl@5c5f1c48 (eProxyURI: __synthetic0.n4js,js#|3)> was not:<eu.numberfour.n4js.n4JS.impl.N4ClassDeclarationImpl@6839ea58 (name: Class1, accessModifier: project, abstract: false)>
