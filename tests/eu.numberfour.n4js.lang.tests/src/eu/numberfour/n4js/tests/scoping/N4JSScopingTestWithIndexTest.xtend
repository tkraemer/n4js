...
class N4JSScopingTestWithIndexTest {
	...
	def void testImportExportMemberDeserialize() {
		doTestImportExportMemberDeserialize("src/eu/numberfour/n4js/tests/scoping/Supplier.n4js", "Supplier",
			...
			'''
				...
				<types:TModule xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:typeRefs="http://www.numberfour.eu/ide/ts/TypeRefs" xmlns:types="http://www.numberfour.eu/ide/ts/Types" qualifiedName="eu/numberfour/n4js/tests/scoping/Supplier" vendorID="eu.numberfour" projectArtifactId="eu.numberfour.n4js.lang.tests" moduleLoader="N4JS">
				  <astElement href="#/0"/>
	...
	def void testImportExportMemberDeserializeWithBuiltIn() {
		doTestImportExportMemberDeserialize("src/eu/numberfour/n4js/tests/scoping/SupplierWithBuiltIn.n4js",
			...
			'''
				<?xml version="1.0" encoding="ASCII"?>
				<types:TModule xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:typeRefs="http://www.numberfour.eu/ide/ts/TypeRefs" xmlns:types="http://www.numberfour.eu/ide/ts/Types" qualifiedName="eu/numberfour/n4js/tests/scoping/SupplierWithBuiltIn" vendorID="eu.numberfour" projectArtifactId="eu.numberfour.n4js.lang.tests" moduleLoader="N4JS">
				  <astElement href="#/0"/>
