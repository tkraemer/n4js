...
class VariablesAndConstantsTypesBuilderTest extends AbstractTypesBuilderTest {
	...
	override assertExampleTypeStructure(String phase, Resource newN4jsResource) {
		...
		assertBuiltinTypeFragmentURI(phase, newN4jsResource, firstVariableType, "//@types.5")  // int
		...
		assertBuiltinTypeFragmentURI(phase, newN4jsResource, fourthVariableType, "//@types.4")
