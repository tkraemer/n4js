...
import eu.numberfour.n4js.tester.nodejs.ui.NodejsTesterLaunchShortcut;
import eu.numberfour.n4js.tester.ui.N4TesterUiModule;

/**
 * Test for testing the {@code @Ignore} annotation while running tests via Mangelhaft.
 */
@SuppressWarnings("restriction")
public class GH_45_CheckIgnoreAnnotationAtClassLevel_PluginUITest extends AbstractPluginUITest {

	private static final String PROJECT_NAME = "GH-45";
