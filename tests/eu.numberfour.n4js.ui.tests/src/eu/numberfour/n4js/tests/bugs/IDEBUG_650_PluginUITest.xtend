...
class IDEBUG_650_PluginUITest extends AbstractIDEBUG_Test {
	...
	def void buildCheckStubsNotGeneratedForPolyfilledMember_AssertGeneratedOnce() throws CoreException {
		...
		val IProject project = getWorkspace.root.getProject('eu.numberfour.stdlib.model.common');
		val IFile file = project.
			getFile('''src-gen/«ES5_SUB_GENERATOR_ID»/eu.numberfour.stdlib.model.common/n4/model/common/TimezoneRegion.js''');
