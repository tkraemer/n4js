...
public class IDEBUG_647_PluginUITest extends AbstractIDEBUG_Test {
	...
	public void buildCheckGeneratedFileExists_AssertExists() throws CoreException {
		...
		final IProject project = getWorkspace().getRoot().getProject("eu.numberfour.stdlib.model.common");

		final IFile file = project.getFile(
				"src-gen/" + ES5_SUB_GENERATOR_ID
						+ "/eu.numberfour.stdlib.model.common/n4/model/common/TimezoneRegion.js");
