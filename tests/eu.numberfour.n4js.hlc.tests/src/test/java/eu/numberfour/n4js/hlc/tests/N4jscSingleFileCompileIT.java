...
public class N4jscSingleFileCompileIT extends AbstractN4jscIT {
	...
	public void testCompileAllAndRunWithNodejsPlugin() throws Exception {
		...
		// check end of output.
		N4CliHelper.assertEndOfOutputExpectedToContain(N4jsc.MARKER_RUNNER_OUPTUT, "Arrghtutut§", outputLogFile);
	...
	public void testApiImplStub_CompileAndRunWithNodejsPlugin() throws Exception {
		...
		// check end of output.
		N4CliHelper.assertEndOfOutputExpectedToContain(N4jsc.MARKER_RUNNER_OUPTUT,
	...
	public void test_Run_Not_Compiled_A_WithNodeRunner() throws IOException, InterruptedException {
		...
		assertEquals("Exit with wrong exitcode.", N4jsc.EXITCODE_RUNNER_STOPPED_WITH_ERROR, exitCode);
