...
import static eu.numberfour.n4js.ts.types.MemberAccessModifier.PRIVATE;
import static eu.numberfour.n4js.ts.types.MemberAccessModifier.PROJECT;
import static eu.numberfour.n4js.ts.types.MemberAccessModifier.PROTECTED;
import static eu.numberfour.n4js.ts.types.MemberAccessModifier.PROTECTED_INTERNAL;
import static eu.numberfour.n4js.ts.types.MemberAccessModifier.PUBLIC;
import static eu.numberfour.n4js.ts.types.MemberAccessModifier.PUBLIC_INTERNAL;
import static eu.numberfour.n4js.ts.types.util.AccessModifiers.less;
...
public class AccessModifiersTest {
	...
	/**
	 * Test method for
	 * {@link eu.numberfour.n4js.ts.types.util.AccessModifiers#less(eu.numberfour.n4js.ts.types.MemberAccessModifier, eu.numberfour.n4js.ts.types.MemberAccessModifier)}
	 * .
	 */
	@Test
