...
import static eu.numberfour.n4js.AnnotationDefinition.PROVIDES_DEFAULT_IMPLEMENTATION;
import static eu.numberfour.n4js.AnnotationDefinition.PROVIDES_INITIALZER;
...
import eu.numberfour.n4js.ts.types.impl.TFieldImpl;
import eu.numberfour.n4js.ts.types.impl.TGetterImpl;
import eu.numberfour.n4js.ts.types.impl.TMethodImpl;
import eu.numberfour.n4js.ts.types.impl.TSetterImpl;
import eu.numberfour.n4js.ts.types.util.AccessorTuple;
...
public class ScriptApiTracker {
	...
	/**
	 * Compares artifactId and vendorId
	 */
