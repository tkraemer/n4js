 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.ParameterizedTypeRefStructural_IMImpl#getAstStructuralMembers <em>Ast Structural Members</em>}</li>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.ParameterizedTypeRefStructural_IMImpl#getStructuralType <em>Structural Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.ParameterizedTypeRefStructural_IMImpl#getGenStructuralMembers <em>Gen Structural Members</em>}</li>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.ParameterizedTypeRefStructural_IMImpl#getPostponedSubstitutions <em>Postponed Substitutions</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == TypeRef.class) {
			switch (baseOperationID) {
				...
				case TypeRefsPackage.TYPE_REF___GET_DECLARED_TYPE: return ImPackage.PARAMETERIZED_TYPE_REF_STRUCTURAL_IM___GET_DECLARED_TYPE;
