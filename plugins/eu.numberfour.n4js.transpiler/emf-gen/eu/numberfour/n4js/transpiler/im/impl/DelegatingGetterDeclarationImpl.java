...
import eu.numberfour.n4js.n4JS.impl.N4GetterDeclarationImpl;

import eu.numberfour.n4js.transpiler.im.DelegatingGetterDeclaration;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Delegating Getter Declaration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.DelegatingGetterDeclarationImpl#getDelegationBaseType <em>Delegation Base Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.DelegatingGetterDeclarationImpl#getDelegationSuperClassSteps <em>Delegation Super Class Steps</em>}</li>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.DelegatingGetterDeclarationImpl#getDelegationTarget <em>Delegation Target</em>}</li>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.impl.DelegatingGetterDeclarationImpl#isDelegationTargetIsAbstract <em>Delegation Target Is Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DelegatingGetterDeclarationImpl extends N4GetterDeclarationImpl implements DelegatingGetterDeclaration {
	/**
	 ...
	 * @generated
	 */
	protected DelegatingGetterDeclarationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ImPackage.Literals.DELEGATING_GETTER_DECLARATION;
	}
		...
		if (delegationBaseType != null && delegationBaseType.eIsProxy()) {
			...
			if (delegationBaseType != oldDelegationBaseType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_BASE_TYPE, oldDelegationBaseType, delegationBaseType));
			}
		}
	...
	public void setDelegationSuperClassSteps(int newDelegationSuperClassSteps) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_SUPER_CLASS_STEPS, oldDelegationSuperClassSteps, delegationSuperClassSteps));
	}
	...
	public SymbolTableEntryOriginal getDelegationTarget() {
		if (delegationTarget != null && delegationTarget.eIsProxy()) {
			...
			if (delegationTarget != oldDelegationTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_TARGET, oldDelegationTarget, delegationTarget));
			}
		}
	...
	public void setDelegationTargetIsAbstract(boolean newDelegationTargetIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_TARGET_IS_ABSTRACT, oldDelegationTargetIsAbstract, delegationTargetIsAbstract));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DelegatingMember.class) {
			switch (derivedFeatureID) {
				case ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_BASE_TYPE: return ImPackage.DELEGATING_MEMBER__DELEGATION_BASE_TYPE;
				case ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_SUPER_CLASS_STEPS: return ImPackage.DELEGATING_MEMBER__DELEGATION_SUPER_CLASS_STEPS;
				case ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_TARGET: return ImPackage.DELEGATING_MEMBER__DELEGATION_TARGET;
				case ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_TARGET_IS_ABSTRACT: return ImPackage.DELEGATING_MEMBER__DELEGATION_TARGET_IS_ABSTRACT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DelegatingMember.class) {
			switch (baseFeatureID) {
				case ImPackage.DELEGATING_MEMBER__DELEGATION_BASE_TYPE: return ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_BASE_TYPE;
				case ImPackage.DELEGATING_MEMBER__DELEGATION_SUPER_CLASS_STEPS: return ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_SUPER_CLASS_STEPS;
				case ImPackage.DELEGATING_MEMBER__DELEGATION_TARGET: return ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_TARGET;
				case ImPackage.DELEGATING_MEMBER__DELEGATION_TARGET_IS_ABSTRACT: return ImPackage.DELEGATING_GETTER_DECLARATION__DELEGATION_TARGET_IS_ABSTRACT;
				default: return -1;
			}
		}
...
} //DelegatingGetterDeclarationImpl
