 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.SymbolTableEntryOriginal#getOriginalTarget <em>Original Target</em>}</li>
 *   <li>{@link eu.numberfour.n4js.transpiler.im.SymbolTableEntryOriginal#getImportSpecifier <em>Import Specifier</em>}</li>
 * </ul>
 *
 * @see eu.numberfour.n4js.transpiler.im.ImPackage#getSymbolTableEntryOriginal()
 * @model
 * @generated
 */
public interface SymbolTableEntryOriginal extends SymbolTableEntry {
	 ...
	 * @see eu.numberfour.n4js.transpiler.im.ImPackage#getSymbolTableEntryOriginal_OriginalTarget()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.transpiler.im.SymbolTableEntryOriginal#getOriginalTarget <em>Original Target</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.numberfour.n4js.transpiler.im.ImPackage#getSymbolTableEntryOriginal_ImportSpecifier()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.transpiler.im.SymbolTableEntryOriginal#getImportSpecifier <em>Import Specifier</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='final <%eu.numberfour.n4js.ts.types.IdentifiableElement%> trgt = this.getOriginalTarget();\nif ((trgt instanceof <%eu.numberfour.n4js.ts.types.TExportableElement%>))\n{\n\treturn ((<%eu.numberfour.n4js.ts.types.TExportableElement%>)trgt).getExportedName();\n}\n<%eu.numberfour.n4js.ts.types.IdentifiableElement%> _originalTarget = this.getOriginalTarget();\nreturn _originalTarget.getName();'"
	 * @generated
	 */
	String exportedName();
