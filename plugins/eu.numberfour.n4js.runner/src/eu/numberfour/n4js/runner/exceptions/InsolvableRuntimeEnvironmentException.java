 ...
 */
package eu.numberfour.n4js.runner.exceptions;
...
/**
 * Runtime exception indicating that the runtime environment resolution failed for a particular N4 project.
 */
public class InsolvableRuntimeEnvironmentException extends RuntimeException {
	...
	private static final String getMessage(final IN4JSProject project) {
		return format(MSG_TEMPLATE, project.getArtifactId(), project.getProjectType().getName());
	}
}
