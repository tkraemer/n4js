 ...
 */
package eu.numberfour.n4js.n4mf.ui.internal
...
/**
 * Dirty state editor support for N4 manifests. Resolves the resource while loading from the resource set
...
class N4MFDirtyStateEditorSupport extends DirtyStateEditorSupport {
		...
		override def processDelta(IResourceDescription.Delta delta, Resource context, List<Resource> result) {
			...
			// If represents a N4 manifest file and the new resource description is not null, in other words, not deleted.
