...
class WebContentFileWriter {
	...
	private void generateAllPackagesFile(File rootDir, List<SpecFile> specFiles) {
		...
		SpecFile scf = new SpecIndexFile(indexFile, indexContent, "All Packages Overview");
		specFiles.add(scf);
	}
	...
	private void generateAllModulesFile(File rootDir, List<SpecFile> specFiles) {
		...
		SpecFile scf = new SpecIndexFile(indexFile, indexContent, "All Modules Overview");
		specFiles.add(scf);
	}
	...
	private void generatePackageModulesFile(File rootDir, PackageEntry pe, List<SpecFile> specFiles) {
		...
		SpecFile scf = new SpecIndexFile(indexFile, indexContent, "Modules Overview");
		specFiles.add(scf);
	}
