...
public class TypesGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class BindingTypesIdentifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.ts.Types.BindingTypesIdentifier");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cTypesSpecificKeywordsParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public class VoidOrBindingIdentifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.ts.Types.VoidOrBindingIdentifier");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cVoidKeyword_0 = (Keyword)cAlternatives.eContents().get(0);
	...
	public class TypesSpecificKeywordsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.ts.Types.TypesSpecificKeywords");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class TObjectPrototypeElements extends AbstractParserRuleElementFinder {
		...
		//	declaredFinal?='final'?
		//	'object' name=BindingTypesIdentifier ('<' typeVars+=TypeVariable (',' typeVars+=TypeVariable)* '>')? ('extends'
	...
	public class TClassElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cNameBindingTypesIdentifierParserRuleCall_6_0 = (RuleCall)cNameAssignment_6.eContents().get(0);
		private final Group cGroup_7 = (Group)cGroup.eContents().get(7);
		...
		//	declaredFinal?='final'?
		//	'class' typingStrategy=TypingStrategyDefSiteOperator? name=BindingTypesIdentifier ('<'
		...
		//name=BindingTypesIdentifier ('<' typeVars+=TypeVariableWithDefSiteVariance (','
		//typeVars+=TypeVariableWithDefSiteVariance)* '>')? ('extends' superClassRef=ParameterizedTypeRefNominal)? ('implements'
		...
		//BindingTypesIdentifier
		public RuleCall getNameBindingTypesIdentifierParserRuleCall_6_0() { return cNameBindingTypesIdentifierParserRuleCall_6_0; }
	...
	public class TInterfaceElements extends AbstractParserRuleElementFinder {
		...
		//	declaredTypeAccessModifier=TypeAccessModifier
		//	declaredProvidedByRuntime?='providedByRuntime'?
		//	'interface' typingStrategy=TypingStrategyDefSiteOperator? name=BindingTypesIdentifier ('<'
		//	typeVars+=TypeVariableWithDefSiteVariance (',' typeVars+=TypeVariableWithDefSiteVariance)* '>')? ('extends'
		...
		//typeVars+=TypeVariableWithDefSiteVariance (',' typeVars+=TypeVariableWithDefSiteVariance)* '>')? ('extends'
		//superInterfaceRefs+=ParameterizedTypeRefNominal (',' superInterfaceRefs+=ParameterizedTypeRefNominal)*)?
		//annotations+=TAnnotation* '{' ownedMembers+=TMember* '}'
		public Group getGroup() { return cGroup; }
	...
	public class TFormalParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.ts.Types.TFormalParameter");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Group cGroup_4 = (Group)cGroup.eContents().get(4);
		private final Assignment cHasInitializerAssignmentAssignment_4_0 = (Assignment)cGroup_4.eContents().get(0);
		private final Keyword cHasInitializerAssignmentEqualsSignKeyword_4_0_0 = (Keyword)cHasInitializerAssignmentAssignment_4_0.eContents().get(0);
		private final Assignment cHasInitializerAssignment_4_1 = (Assignment)cGroup_4.eContents().get(1);
		private final Keyword cHasInitializerUndefinedKeyword_4_1_0 = (Keyword)cHasInitializerAssignment_4_1.eContents().get(0);
		
		/// **
		// * Default initializers in TFunctions (or FunctionTypeExpressions)
		...
		// * 
		// * Note: Keep the initializer part in sync with: TypeExpressions.xtext:TAnonymousFormalParameter
		// * / TFormalParameter:
		//	variadic?='...'? name=BindingIdentifier<Yield=false>
		//	':' typeRef=TypeRef (hasInitializerAssignment?='=' hasInitializer?='undefined'?)?;
		@Override public ParserRule getRule() { return rule; }
		
		//variadic?='...'? name=BindingIdentifier<Yield=false> ':' typeRef=TypeRef (hasInitializerAssignment?='='
		//hasInitializer?='undefined'?)?
		public Group getGroup() { return cGroup; }
		...
		//(hasInitializerAssignment?='=' hasInitializer?='undefined'?)?
		public Group getGroup_4() { return cGroup_4; }
		
		//hasInitializerAssignment?='='
		public Assignment getHasInitializerAssignmentAssignment_4_0() { return cHasInitializerAssignmentAssignment_4_0; }
		
		//'='
		public Keyword getHasInitializerAssignmentEqualsSignKeyword_4_0_0() { return cHasInitializerAssignmentEqualsSignKeyword_4_0_0; }
		
		//hasInitializer?='undefined'?
		public Assignment getHasInitializerAssignment_4_1() { return cHasInitializerAssignment_4_1; }
		
		//'undefined'
		public Keyword getHasInitializerUndefinedKeyword_4_1_0() { return cHasInitializerUndefinedKeyword_4_1_0; }
	}
	...
	public class TFunctionElements extends AbstractParserRuleElementFinder {
		...
		//typeVars+=TypeVariable (',' typeVars+=TypeVariable)* '>')? name=BindingTypesIdentifier '(' (fpars+=TFormalParameter
	...
	//	variadic?='...'? (=> name=BindingIdentifier<Yield=false> ':')? typeRef=super::TypeRef (hasInitializerAssignment?='='
	...
	//	name=IdentifierName '(') TAnonymousFormalParameterList ')' (':' returnTypeRef=super::TypeRef)?;
