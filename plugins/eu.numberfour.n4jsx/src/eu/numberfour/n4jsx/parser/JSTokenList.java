 ...
 * </p>
 */
// copied form eu.numberfour.n4js.parser.JSTokenList
public class JSTokenList extends ArrayList<Token> {
	...
	public boolean add(Token tok) {
		...
		if (type == InternalN4JSXParser.EqualsSignGreaterThanSign) {
		...
		} else if (type == InternalN4JSXParser.RULE_EOL
				|| type == InternalN4JSXParser.RULE_ML_COMMENT
				|| type == InternalN4JSXParser.RULE_WS
				|| type == InternalN4JSXParser.RULE_SL_COMMENT) {
