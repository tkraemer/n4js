...
import eu.numberfour.n4jsx.parser.antlr.N4JSXParser;
import eu.numberfour.n4jsx.parser.antlr.internal.InternalN4JSXParser;
import eu.numberfour.n4js.parser.AntlrStreamWithToString;

/**
 * <p>
 * This specialization of the {@link N4JSXParser} changes the handling of hidden tokens. Effectively the changeable
 * hidden tokens are disabled in favor of automatic semicolon injection.
 * </p>
 */
// copy of eu.numberfour.n4js.parser.N4JSSemicolonInjectingParser!
public class N4JSXSemicolonInjectingParser extends N4JSXParser {
