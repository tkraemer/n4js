...
// copied form eu.numberfour.n4js.parser.LazyTokenStream
public class LazyTokenStream extends XtextTokenStream {
	...
	protected void fillBuffer() {
		...
		while (t != null && t.getType() != CharStream.EOF) {
			...
			int type = t.getType();
			if (type == InternalN4JSXLexer.Solidus || type == InternalN4JSXLexer.SolidusEqualsSign
					|| type == InternalN4JSXLexer.RightCurlyBracket) {
