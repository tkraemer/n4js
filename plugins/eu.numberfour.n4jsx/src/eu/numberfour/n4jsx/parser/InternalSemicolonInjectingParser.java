...
/**
 * <p>
 * A customized {@link InternalN4JSXParser} that adds behavior which is unique to the JS parser semantics. Especially
 * important is the error recovery which has to be aware of automatically injected semicolons.
 * </p>
 * This parser inherits the generated {@link InternalN4JSXParser}, which already contains customized methods stubs for
 ...
 */
// copy of /eu.numberfour.n4js/src/eu/numberfour/n4js/parser/InternalSemicolonInjectingParser.java!
public class InternalSemicolonInjectingParser extends InternalN4JSXParser implements SemicolonInjectionHelper.Callback {
	 ...
	 */
	InternalSemicolonInjectingParser(TokenStream input, N4JSXGrammarAccess grammarAccess) {
	 ...
	 * {@link eu.numberfour.n4js.antlr.n4js.RegExDisambiguationInjector}, see MWE2 workflow for configuration.
	 * <p>
	 ...
	 * {@link eu.numberfour.n4js.antlr.n4js.TemplateLiteralDisambiguationInjector}, see MWE2 workflow for configuration.
	 * <p>
	 * Overrides method stub generated by customized ANTLR/Xtext generator.
	 * </p>
	 */
	...
	private String bitsetName(BitSet bitset) {
		Optional<Field> findField = Stream.of(InternalN4JSXParser.class.getDeclaredFields())
