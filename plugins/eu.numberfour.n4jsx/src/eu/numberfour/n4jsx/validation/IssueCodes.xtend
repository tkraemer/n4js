...
import eu.numberfour.n4js.utils.NLS
 ...
 * {@code messages.properties}. See {@link eu.numberfour.n4js.utils.NLSProcessor} for details about the message format.
 */
@NLS(propertyFileName="messages")
class IssueCodes extends eu.numberfour.n4js.validation.IssueCodes {}
