 ...
 */
lexer grammar InternalN4JSXLexer;

@header {
package eu.numberfour.n4jsx.parser.antlr.lexer;
...
RULE_TEMPLATE_MIDDLE : { false }?=> '//2';

RULE_TEMPLATE_END : { false }?=> '//3';
