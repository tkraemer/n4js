 ...
 */
package eu.numberfour.n4jsx.services;
...
public class N4JSXGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class IDLScriptElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4jsx.N4JSX.IDLScript");
	...
	public class JSXExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4jsx.N4JSX.JSXExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("eu.numberfour.n4jsx.N4JSX".equals(grammar.getName())) {
				return grammar;
			}
	...
	public N4JSGrammarAccess.TypeVariablesElements getTypeVariablesAccess() {
		return gaN4JS.getTypeVariablesAccess();
	}
	...
	//	FunctionDeclaration<Yield>
	public N4JSGrammarAccess.ExportedFunctionDeclarationElements getExportedFunctionDeclarationAccess() {
		return gaN4JS.getExportedFunctionDeclarationAccess();
	}
	...
	public N4JSGrammarAccess.ColonSepTypeRefElements getColonSepTypeRefAccess() {
		return gaN4JS.getColonSepTypeRefAccess();
	}
	...
	public N4JSGrammarAccess.TypeArgumentsElements getTypeArgumentsAccess() {
		return gaN4JS.getTypeArgumentsAccess();
	}
