...
/**
 * Utility methods for accessing the {@code n4jsc.jar} built in maven project {@code eu.numberfour.n4js.hlc} during the
...
public class N4jscJarUtils {
	...
	public static void buildHeadlessWithN4jscJar(Collection<? extends File> workspaceRoots, String... options) {
		...
		cmdline.addAll(Arrays.asList(
				...
				"-XX:-UseGCOverheadLimit", // TODO IDE-2479 remove once issues resolved
