 ...
 */
package eu.numberfour.n4jsx.ui.handler;
...
public class GeneratedJsFileLocator {
	...
	/**
	 * Tries to locates the generated {@link IFile file} of an N4JSX or pure JSX file give with the argument and returns
	 * with it.
	 *
	 * @param file
	 *            the N4JSX or JSX file. Optional, can be {@code null}.
