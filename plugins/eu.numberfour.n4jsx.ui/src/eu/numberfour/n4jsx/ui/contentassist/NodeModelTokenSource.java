...
import eu.numberfour.n4jsx.ui.contentassist.antlr.lexer.InternalN4JSXLexer;
...
public class NodeModelTokenSource implements TokenSource {
	...
	NodeModelTokenSource(INode node, ContentAssistTokenTypeMapper tokenTypeMapper, N4JSXGrammarAccess grammarAccess) {
	...
	NodeModelTokenSource(INode node, int startOffset, int endOffset, ContentAssistTokenTypeMapper tokenTypeMapper,
			N4JSXGrammarAccess grammarAccess) {
	...
	private Token toPrefixToken(ILeafNode leaf) {
		Lexer lexer = new InternalN4JSXLexer();
