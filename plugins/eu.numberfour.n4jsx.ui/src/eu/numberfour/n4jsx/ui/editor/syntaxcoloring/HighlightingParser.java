...
import eu.numberfour.n4jsx.parser.LazyTokenStream;
import eu.numberfour.n4jsx.services.N4JSXGrammarAccess;
import eu.numberfour.n4js.parser.AntlrStreamWithToString;
import eu.numberfour.n4js.ui.editor.syntaxcoloring.TokenTypeRewriter;

/**
 * Facade for the highlighting parser.
 */
// copy of eu.numberfour.n4js.ui.editor.syntaxcoloring.HighlightingParser
@Singleton
