 ...
 * <p>
 * Usually, instances of {@link eu.numberfour.n4js.ui.changes.IChange IChange} should be created using the methods in
 * class {@link eu.numberfour.n4js.ui.changes.ChangeProvider ChangeProvider} then be applied to one or more documents
 * all in a single step by invoking helper method
 * {@link eu.numberfour.n4js.ui.changes.ChangeManager#applyAll(java.util.Collection) apply()} in
 * {@link eu.numberfour.n4js.ui.changes.ChangeManager}.
 * <p>
