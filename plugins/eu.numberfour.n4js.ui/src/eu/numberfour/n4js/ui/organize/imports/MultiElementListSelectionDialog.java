...
public class MultiElementListSelectionDialog extends AbstractElementListSelectionDialog {
	...
	/**
	 * Sets message shown in the right top corner. Use {0} and {1} as placeholders for the current and the total number
	 * of pages.
	 *
	 * @param message
	 *            the message.
	...
	/*
	 * XXX: Workaround for https://bugs.eclipse.org/bugs/show_bug.cgi?id=279425 The whole method can be removed once
	 * that bug is fixed.
	 *
	...
	private String getPageInfoMessage() {
		...
		return MessageFormat.format(fPageInfoMessage, (Object[]) args);
	}
