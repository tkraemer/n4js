 ...
 *
 *******************************************************************************/
package eu.nmberfour.n4js.ui.logging;
...
public class EclipseLogAppender extends AppenderSkeleton {
	...
	private IStatus createStatus(int severity, @SuppressWarnings("unused") String loggerName, String message,
			Throwable throwable) {
		return new Status(severity, LOG4J_BUNDLE_NAME, message, throwable);
	}

	@Override
	public void close() { // n.t.d.
	}
