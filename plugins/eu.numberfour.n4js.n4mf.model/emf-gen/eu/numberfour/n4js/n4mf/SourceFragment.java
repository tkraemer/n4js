 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.n4mf.SourceFragment#getSourceFragmentType <em>Source Fragment Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.SourceFragment#getPaths <em>Paths</em>}</li>
 * </ul>
 *
 * @see eu.numberfour.n4js.n4mf.N4mfPackage#getSourceFragment()
 * @model
 * @generated
 */
public interface SourceFragment extends EObject {
	 ...
	 * The literals are from the enumeration {@link eu.numberfour.n4js.n4mf.SourceFragmentType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.numberfour.n4js.n4mf.N4mfPackage#getSourceFragment_SourceFragmentType()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.n4mf.SourceFragment#getSourceFragmentType <em>Source Fragment Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.numberfour.n4js.n4mf.N4mfPackage#getSourceFragment_Paths()
	 * @model unique="false"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='if ((null == other))\n{\n\treturn (-1);\n}\n<%eu.numberfour.n4js.n4mf.SourceFragmentType%> _sourceFragmentType = this.getSourceFragmentType();\nboolean _tripleEquals = (null == _sourceFragmentType);\nif (_tripleEquals)\n{\n\tint _xifexpression = (int) 0;\n\t<%eu.numberfour.n4js.n4mf.SourceFragmentType%> _sourceFragmentType_1 = other.getSourceFragmentType();\n\tboolean _tripleEquals_1 = (null == _sourceFragmentType_1);\n\tif (_tripleEquals_1)\n\t{\n\t\t_xifexpression = 0;\n\t}\n\telse\n\t{\n\t\t_xifexpression = 1;\n\t}\n\treturn _xifexpression;\n}\n<%eu.numberfour.n4js.n4mf.SourceFragmentType%> _sourceFragmentType_2 = this.getSourceFragmentType();\n<%eu.numberfour.n4js.n4mf.SourceFragmentType%> _sourceFragmentType_3 = other.getSourceFragmentType();\nreturn _sourceFragmentType_2.compareTo(_sourceFragmentType_3);'"
	 * @generated
	 */
