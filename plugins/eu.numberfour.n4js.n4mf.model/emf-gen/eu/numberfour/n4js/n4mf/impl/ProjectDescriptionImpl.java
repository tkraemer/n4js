...
import eu.numberfour.n4js.n4mf.InitModules;
...
import eu.numberfour.n4js.n4mf.ProjectDependencies;
...
import eu.numberfour.n4js.n4mf.ProvidedRuntimeLibraries;
import eu.numberfour.n4js.n4mf.ProvidedRuntimeLibraryDependency;
import eu.numberfour.n4js.n4mf.RequiredRuntimeLibraries;
import eu.numberfour.n4js.n4mf.RequiredRuntimeLibraryDependency;
import eu.numberfour.n4js.n4mf.SourceFragment;
import eu.numberfour.n4js.n4mf.TestedProject;
import eu.numberfour.n4js.n4mf.TestedProjects;
 ...
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getMainModule <em>Main Module</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getExtendedRuntimeEnvironment <em>Extended Runtime Environment</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getProvidedRuntimeLibraries <em>Provided Runtime Libraries</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getRequiredRuntimeLibraries <em>Required Runtime Libraries</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getProjectDependencies <em>Project Dependencies</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getImplementationId <em>Implementation Id</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getImplementedProjects <em>Implemented Projects</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getInitModules <em>Init Modules</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getExecModule <em>Exec Module</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getOutputPath <em>Output Path</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getLibraryPaths <em>Library Paths</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getResourcePaths <em>Resource Paths</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getSourceFragment <em>Source Fragment</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getModuleFilters <em>Module Filters</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getTestedProjects <em>Tested Projects</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ProjectDescriptionImpl#getModuleLoader <em>Module Loader</em>}</li>
 * </ul>
 *
 * @generated
 */
