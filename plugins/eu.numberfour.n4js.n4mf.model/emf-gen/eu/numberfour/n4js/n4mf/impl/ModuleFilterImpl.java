 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ModuleFilterImpl#getModuleFilterType <em>Module Filter Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ModuleFilterImpl#getModuleSpecifiers <em>Module Specifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleFilterImpl extends MinimalEObjectImpl.Container implements ModuleFilter {
	...
	protected EClass eStaticClass() {
		return N4mfPackage.Literals.MODULE_FILTER;
	}
	...
	public void setModuleFilterType(ModuleFilterType newModuleFilterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4mfPackage.MODULE_FILTER__MODULE_FILTER_TYPE, oldModuleFilterType, moduleFilterType));
	}
	...
	public EList<ModuleFilterSpecifier> getModuleSpecifiers() {
		if (moduleSpecifiers == null) {
			moduleSpecifiers = new EObjectContainmentEList<ModuleFilterSpecifier>(ModuleFilterSpecifier.class, this, N4mfPackage.MODULE_FILTER__MODULE_SPECIFIERS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case N4mfPackage.MODULE_FILTER__MODULE_FILTER_TYPE:
