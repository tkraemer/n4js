 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ModuleFilterSpecifierImpl#getModuleSpecifierWithWildcard <em>Module Specifier With Wildcard</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4mf.impl.ModuleFilterSpecifierImpl#getSourcePath <em>Source Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleFilterSpecifierImpl extends MinimalEObjectImpl.Container implements ModuleFilterSpecifier {
	...
	protected EClass eStaticClass() {
		return N4mfPackage.Literals.MODULE_FILTER_SPECIFIER;
	}
	...
	public void setModuleSpecifierWithWildcard(String newModuleSpecifierWithWildcard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4mfPackage.MODULE_FILTER_SPECIFIER__MODULE_SPECIFIER_WITH_WILDCARD, oldModuleSpecifierWithWildcard, moduleSpecifierWithWildcard));
	}
	...
	public void setSourcePath(String newSourcePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4mfPackage.MODULE_FILTER_SPECIFIER__SOURCE_PATH, oldSourcePath, sourcePath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case N4mfPackage.MODULE_FILTER_SPECIFIER__SOURCE_PATH:
