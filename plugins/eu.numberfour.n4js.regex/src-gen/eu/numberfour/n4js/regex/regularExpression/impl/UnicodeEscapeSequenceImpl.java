 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.regex.regularExpression.impl.UnicodeEscapeSequenceImpl#getCharacter <em>Character</em>}</li>
 *   <li>{@link eu.numberfour.n4js.regex.regularExpression.impl.UnicodeEscapeSequenceImpl#getSequence <em>Sequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnicodeEscapeSequenceImpl extends AtomEscapeImpl implements UnicodeEscapeSequence
{
  ...
  public void setCharacter(String newCharacter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RegularExpressionPackage.UNICODE_ESCAPE_SEQUENCE__CHARACTER, oldCharacter, character));
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CharacterClassAtom.class)
    {
      switch (derivedFeatureID)
      {
        case RegularExpressionPackage.UNICODE_ESCAPE_SEQUENCE__CHARACTER: return RegularExpressionPackage.CHARACTER_CLASS_ATOM__CHARACTER;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CharacterClassAtom.class)
    {
      switch (baseFeatureID)
      {
        case RegularExpressionPackage.CHARACTER_CLASS_ATOM__CHARACTER: return RegularExpressionPackage.UNICODE_ESCAPE_SEQUENCE__CHARACTER;
        default: return -1;
      }
    }
    if (baseClass == EscapedCharacterClassAtom.class)
