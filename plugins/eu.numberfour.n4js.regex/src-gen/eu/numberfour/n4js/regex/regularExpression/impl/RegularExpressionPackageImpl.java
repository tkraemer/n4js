...
import eu.numberfour.n4js.regex.regularExpression.Backspace;
import eu.numberfour.n4js.regex.regularExpression.CharacterClass;
...
import eu.numberfour.n4js.regex.regularExpression.CharacterClassRange;
import eu.numberfour.n4js.regex.regularExpression.CharacterEscapeSequence;
import eu.numberfour.n4js.regex.regularExpression.ControlLetterEscapeSequence;
...
import eu.numberfour.n4js.regex.regularExpression.ExactQuantifier;
import eu.numberfour.n4js.regex.regularExpression.Group;
import eu.numberfour.n4js.regex.regularExpression.HexEscapeSequence;
import eu.numberfour.n4js.regex.regularExpression.IdentityEscapeSequence;
import eu.numberfour.n4js.regex.regularExpression.LineEnd;
import eu.numberfour.n4js.regex.regularExpression.LineStart;
import eu.numberfour.n4js.regex.regularExpression.LookAhead;
import eu.numberfour.n4js.regex.regularExpression.Pattern;
import eu.numberfour.n4js.regex.regularExpression.PatternCharacter;
import eu.numberfour.n4js.regex.regularExpression.Quantifier;
import eu.numberfour.n4js.regex.regularExpression.RegularExpressionBody;
import eu.numberfour.n4js.regex.regularExpression.RegularExpressionFactory;
import eu.numberfour.n4js.regex.regularExpression.RegularExpressionFlags;
import eu.numberfour.n4js.regex.regularExpression.RegularExpressionLiteral;
import eu.numberfour.n4js.regex.regularExpression.RegularExpressionPackage;
import eu.numberfour.n4js.regex.regularExpression.Sequence;
import eu.numberfour.n4js.regex.regularExpression.SimpleQuantifier;
import eu.numberfour.n4js.regex.regularExpression.UnicodeEscapeSequence;
import eu.numberfour.n4js.regex.regularExpression.Wildcard;
import eu.numberfour.n4js.regex.regularExpression.WordBoundary;
...
public class RegularExpressionPackageImpl extends EPackageImpl implements RegularExpressionPackage
{
   ...
   * @see eu.numberfour.n4js.regex.regularExpression.RegularExpressionPackage#eNS_URI
   * @see #init()
   * @generated
   */
