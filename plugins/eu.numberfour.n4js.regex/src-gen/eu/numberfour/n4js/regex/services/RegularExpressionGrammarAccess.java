 ...
 */
package eu.numberfour.n4js.regex.services;
...
public class RegularExpressionGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RegularExpressionLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.RegularExpressionLiteral");
	...
	public class RegularExpressionBodyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.RegularExpressionBody");
	...
	public class DisjunctionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Disjunction");
	...
	public class AlternativeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Alternative");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TermElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Term");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class AssertionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Assertion");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class LineStartElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.LineStart");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LineEndElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.LineEnd");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class WordBoundaryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.WordBoundary");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LookAheadElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.LookAhead");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AtomElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Atom");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class PatternCharacterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.PatternCharacter");
	...
	public class WildcardElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Wildcard");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AtomEscapeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.AtomEscape");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class CharacterClassEscapeSequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CharacterClassEscapeSequence");
	...
	public class CharacterEscapeSequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CharacterEscapeSequence");
		private final Assignment cSequenceAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ControlLetterEscapeSequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.ControlLetterEscapeSequence");
		private final Assignment cSequenceAssignment = (Assignment)rule.eContents().get(1);
	...
	public class HexEscapeSequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.HexEscapeSequence");
		private final Assignment cSequenceAssignment = (Assignment)rule.eContents().get(1);
	...
	public class UnicodeEscapeSequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.UnicodeEscapeSequence");
		private final Assignment cSequenceAssignment = (Assignment)rule.eContents().get(1);
	...
	public class IdentityEscapeSequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.IdentityEscapeSequence");
		private final Assignment cSequenceAssignment = (Assignment)rule.eContents().get(1);
	...
	public class DecimalEscapeSequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.DecimalEscapeSequence");
		private final Assignment cSequenceAssignment = (Assignment)rule.eContents().get(1);
	...
	public class CharacterClassElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CharacterClass");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CharacterClassElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CharacterClassElement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CharacterClassAtomElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CharacterClassAtom");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EscapedCharacterClassAtomElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.EscapedCharacterClassAtom");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cDecimalEscapeSequenceParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public class BackspaceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Backspace");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GroupElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Group");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class QuantifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.Quantifier");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SimpleQuantifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.SimpleQuantifier");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExactQuantifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.ExactQuantifier");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RegularExpressionFlagsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.RegularExpressionFlags");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class INTElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.INT");
	...
	public RegularExpressionGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tWORD_BOUNDARY = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.WORD_BOUNDARY");
		this.tNOT_WORD_BOUNDARY = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.NOT_WORD_BOUNDARY");
		this.tCHARACTER_CLASS_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CHARACTER_CLASS_ESCAPE");
		this.tCONTROL_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CONTROL_ESCAPE");
		this.tCONTROL_LETTER_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.CONTROL_LETTER_ESCAPE");
		this.tHEX_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.HEX_ESCAPE");
		this.tUNICODE_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.UNICODE_ESCAPE");
		this.tDECIMAL_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.DECIMAL_ESCAPE");
		this.tIDENTITY_ESCAPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.IDENTITY_ESCAPE");
		this.tUNICODE_DIGIT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.UNICODE_DIGIT");
		this.tUNICODE_LETTER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.UNICODE_LETTER");
		this.tPATTERN_CHARACTER_NO_DASH = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "eu.numberfour.n4js.regex.RegularExpression.PATTERN_CHARACTER_NO_DASH");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("eu.numberfour.n4js.regex.RegularExpression".equals(grammar.getName())) {
				return grammar;
			}
