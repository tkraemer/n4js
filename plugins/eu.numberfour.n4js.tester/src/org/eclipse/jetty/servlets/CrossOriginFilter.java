 ...
 * <b>false</b></li>
 * <li><b>exposeHeaders</b>, a comma separated list of HTTP headers that are allowed to be exposed on the client.
 * Default value is the <b>empty list</b></li>
 * <li><b>chainPreflight</b>, if true preflight requests are chained to their target resource for normal handling (as an
 * OPTION request). Otherwise the filter will response to the preflight. Default is true.</li>
 * </ul>
 * </p>
 * <p>
...
public class CrossOriginFilter implements Filter
{
	...
	private void handleSimpleResponse(@SuppressWarnings("unused") HttpServletRequest request,
