...
public enum ContentType {
	...
	START_SESSION("application/vnd.n4.ide.start_session_req.tm+json"),
	/** Content type for the {@code end session} RESTful resource. */
	END_SESSION("application/vnd.n4.ide.end_session_req.tm+json"),
	/** Content type for the {@code ping session} RESTful resource. */
	PING_SESSION("application/vnd.n4.ide.ping_session_req.tm+json"),
	/** Content type for the {@code start test} RESTful resource. */
	START_TEST("application/vnd.n4.ide.start_test_req.tm+json"),
	/** Content type for the {@code end test} RESTful resource. */
	END_TEST("application/vnd.n4.ide.end_test_req.tm+json"),
	/** Content type for the {@code ping test} RESTful resource. */
	PING_TEST("application/vnd.n4.ide.ping_test_req.tm+json"),
	/** Content type for assembling the test catalog RESTful resource. */
	ASSEMBLE_TEST_CATALOG("application/vnd.n4.ide.assemble_test_catalog_req.tm+json");
