...
public class StartTestResource extends TestResource {
	...
	private static final class StartTestResponse {
		private static final String PING_TEMP = "/n4.ide/testing/sessions/{0}/tests/{1}/ping";
		private static final String END_TEMP = "/n4.ide/testing/sessions/{0}/tests/{1}/end";
