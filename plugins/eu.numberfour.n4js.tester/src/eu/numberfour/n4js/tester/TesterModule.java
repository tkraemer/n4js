...
import static eu.numberfour.n4js.tester.TesterModuleDefaults.DEFAULT_FSM_TIMEOUT_VALUE;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.DUMP_SERVER_ON_STOP_KEY;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.DUMP_SERVER_ON_STOP_VALUE;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.HTTP_SERVER_PORT_KEY;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.HTTP_SERVER_PORT_VALUE;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.MAX_THREAD_COUNT_KEY;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.MAX_THREAD_COUNT_VALUE;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.MIN_THREAD_COUNT_KEY;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.MIN_THREAD_COUNT_VALUE;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.SETUP_FSM_TIMEOUT_KEY;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.SETUP_FSM_TIMEOUT_VALUE;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.TEST_TREE_TIMEOUT_KEY;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.TEST_TREE_TIMEOUT_VALUE;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.THREAD_POOL_BLOCKING_CAPACITY_KEY;
import static eu.numberfour.n4js.tester.TesterModuleDefaults.THREAD_POOL_BLOCKING_CAPACITY_VALUE;
...
import eu.numberfour.n4js.tester.fsm.TestFsm;
import eu.numberfour.n4js.tester.fsm.TestFsmImpl;
import eu.numberfour.n4js.tester.fsm.TestFsmRegistry;
import eu.numberfour.n4js.tester.fsm.TestFsmRegistryImpl;
...
import eu.numberfour.n4js.tester.internal.TestTreeRegistryImpl;
import eu.numberfour.n4js.tester.internal.TesterFacadeImpl;
import eu.numberfour.n4js.tester.internal.Utf8UrlDecoderService;
...
public class TesterModule extends AbstractModule {
	...
	private Properties getProperties() {
		...
		try {
			final URL url = new URL("platform:/plugin/eu.numberfour.n4js.tester/module.properties");
