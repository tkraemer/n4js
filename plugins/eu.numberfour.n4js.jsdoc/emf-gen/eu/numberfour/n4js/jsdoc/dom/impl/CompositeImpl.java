 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.jsdoc.dom.impl.CompositeImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CompositeImpl extends JSDocNodeImpl implements Composite {
	/**
	 ...
	 * @ordered
	 */
	protected EList<ContentNode> contents;
	...
	protected EClass eStaticClass() {
		return DomPackage.Literals.COMPOSITE;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DomPackage.COMPOSITE__CONTENTS:
				getContents().clear();
				getContents().addAll((Collection<? extends ContentNode>)newValue);
				return;
		}
