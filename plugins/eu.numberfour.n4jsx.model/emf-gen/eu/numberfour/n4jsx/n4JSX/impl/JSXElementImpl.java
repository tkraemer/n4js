...
import eu.numberfour.n4js.n4JS.impl.ExpressionImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4jsx.n4JSX.impl.JSXElementImpl#getJsxElementName <em>Jsx Element Name</em>}</li>
 *   <li>{@link eu.numberfour.n4jsx.n4JSX.impl.JSXElementImpl#getJsxClosingName <em>Jsx Closing Name</em>}</li>
 *   <li>{@link eu.numberfour.n4jsx.n4JSX.impl.JSXElementImpl#getJsxAttributes <em>Jsx Attributes</em>}</li>
 *   <li>{@link eu.numberfour.n4jsx.n4JSX.impl.JSXElementImpl#getJsxChildren <em>Jsx Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JSXElementImpl extends ExpressionImpl implements JSXElement {
	...
	protected EClass eStaticClass() {
		return N4JSXPackage.Literals.JSX_ELEMENT;
	}
	...
	public NotificationChain basicSetJsxElementName(JSXElementName newJsxElementName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, N4JSXPackage.JSX_ELEMENT__JSX_ELEMENT_NAME, oldJsxElementName, newJsxElementName);
	...
	public void setJsxElementName(JSXElementName newJsxElementName) {
		if (newJsxElementName != jsxElementName) {
			...
			if (jsxElementName != null)
				msgs = ((InternalEObject)jsxElementName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N4JSXPackage.JSX_ELEMENT__JSX_ELEMENT_NAME, null, msgs);
			if (newJsxElementName != null)
				msgs = ((InternalEObject)newJsxElementName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N4JSXPackage.JSX_ELEMENT__JSX_ELEMENT_NAME, null, msgs);
			msgs = basicSetJsxElementName(newJsxElementName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4JSXPackage.JSX_ELEMENT__JSX_ELEMENT_NAME, newJsxElementName, newJsxElementName));
	}
	...
	public NotificationChain basicSetJsxClosingName(JSXElementName newJsxClosingName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, N4JSXPackage.JSX_ELEMENT__JSX_CLOSING_NAME, oldJsxClosingName, newJsxClosingName);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setJsxClosingName(JSXElementName newJsxClosingName) {
		if (newJsxClosingName != jsxClosingName) {
			...
			if (jsxClosingName != null)
				msgs = ((InternalEObject)jsxClosingName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N4JSXPackage.JSX_ELEMENT__JSX_CLOSING_NAME, null, msgs);
			if (newJsxClosingName != null)
				msgs = ((InternalEObject)newJsxClosingName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N4JSXPackage.JSX_ELEMENT__JSX_CLOSING_NAME, null, msgs);
			msgs = basicSetJsxClosingName(newJsxClosingName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4JSXPackage.JSX_ELEMENT__JSX_CLOSING_NAME, newJsxClosingName, newJsxClosingName));
	}
	...
	public EList<JSXAttribute> getJsxAttributes() {
		if (jsxAttributes == null) {
			jsxAttributes = new EObjectContainmentEList<JSXAttribute>(JSXAttribute.class, this, N4JSXPackage.JSX_ELEMENT__JSX_ATTRIBUTES);
		}
	...
	public EList<JSXChild> getJsxChildren() {
		if (jsxChildren == null) {
			jsxChildren = new EObjectContainmentEList<JSXChild>(JSXChild.class, this, N4JSXPackage.JSX_ELEMENT__JSX_CHILDREN);
		}
		return jsxChildren;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case N4JSXPackage.JSX_ELEMENT__JSX_ELEMENT_NAME:
				return basicSetJsxElementName(null, msgs);
			case N4JSXPackage.JSX_ELEMENT__JSX_CLOSING_NAME:
				return basicSetJsxClosingName(null, msgs);
			case N4JSXPackage.JSX_ELEMENT__JSX_ATTRIBUTES:
				return ((InternalEList<?>)getJsxAttributes()).basicRemove(otherEnd, msgs);
			case N4JSXPackage.JSX_ELEMENT__JSX_CHILDREN:
