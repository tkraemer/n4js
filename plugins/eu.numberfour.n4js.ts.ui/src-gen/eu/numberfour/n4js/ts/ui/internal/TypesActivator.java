...
import eu.numberfour.n4js.ts.TypeExpressionsRuntimeModule;
import eu.numberfour.n4js.ts.TypesRuntimeModule;
import eu.numberfour.n4js.ts.ui.TypeExpressionsUiModule;
import eu.numberfour.n4js.ts.ui.TypesUiModule;
...
public class TypesActivator extends AbstractUIPlugin {
	...
	protected Module getRuntimeModule(String grammar) {
		if (EU_NUMBERFOUR_N4JS_TS_TYPEEXPRESSIONS.equals(grammar)) {
			return new TypeExpressionsRuntimeModule();
		}
		if (EU_NUMBERFOUR_N4JS_TS_TYPES.equals(grammar)) {
			return new TypesRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (EU_NUMBERFOUR_N4JS_TS_TYPEEXPRESSIONS.equals(grammar)) {
			return new TypeExpressionsUiModule(this);
		}
		if (EU_NUMBERFOUR_N4JS_TS_TYPES.equals(grammar)) {
			return new TypesUiModule(this);
		}
		throw new IllegalArgumentException(grammar);
	}
