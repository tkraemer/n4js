 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.ExistentialTypeRef#getWildcard <em>Wildcard</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.ExistentialTypeRef#getBoundTypeVariable <em>Bound Type Variable</em>}</li>
 * </ul>
 *
 * @see eu.numberfour.n4js.ts.typeRefs.TypeRefsPackage#getExistentialTypeRef()
 * @model
 * @generated
 */
public interface ExistentialTypeRef extends TypeRef {
	 ...
	 * @see eu.numberfour.n4js.ts.typeRefs.TypeRefsPackage#getExistentialTypeRef_Wildcard()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.ts.typeRefs.ExistentialTypeRef#getWildcard <em>Wildcard</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.numberfour.n4js.ts.typeRefs.TypeRefsPackage#getExistentialTypeRef_BoundTypeVariable()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.ts.typeRefs.ExistentialTypeRef#getBoundTypeVariable <em>Bound Type Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='&lt;%eu.numberfour.n4js.ts.typeRefs.Wildcard%&gt; _wildcard = this.getWildcard();\n&lt;%java.lang.String%&gt; _typeRefAsString = null;\nif (_wildcard!=null)\n{\n\t_typeRefAsString=_wildcard.getTypeRefAsString();\n}\nreturn _typeRefAsString;'"
	 * @generated
	 */
