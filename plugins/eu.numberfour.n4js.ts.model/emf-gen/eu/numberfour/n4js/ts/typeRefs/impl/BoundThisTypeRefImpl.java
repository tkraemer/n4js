 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.impl.BoundThisTypeRefImpl#getAstStructuralMembers <em>Ast Structural Members</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.impl.BoundThisTypeRefImpl#getStructuralType <em>Structural Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.impl.BoundThisTypeRefImpl#getGenStructuralMembers <em>Gen Structural Members</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.impl.BoundThisTypeRefImpl#getPostponedSubstitutions <em>Postponed Substitutions</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.impl.BoundThisTypeRefImpl#getActualThisTypeRef <em>Actual This Type Ref</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.impl.BoundThisTypeRefImpl#getDefinedTypingStrategy <em>Defined Typing Strategy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoundThisTypeRefImpl extends ThisTypeRefImpl implements BoundThisTypeRef {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == VersionedElement.class) {
			switch (baseOperationID) {
				case TypeRefsPackage.VERSIONED_ELEMENT___GET_VERSION: return TypeRefsPackage.BOUND_THIS_TYPE_REF___GET_VERSION;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
