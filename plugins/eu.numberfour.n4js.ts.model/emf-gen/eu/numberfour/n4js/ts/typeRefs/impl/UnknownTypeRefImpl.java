 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.impl.UnknownTypeRefImpl#getTypeName <em>Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnknownTypeRefImpl extends TypeRefImpl implements UnknownTypeRef {
	...
	public void setTypeName(String newTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeRefsPackage.UNKNOWN_TYPE_REF__TYPE_NAME, oldTypeName, typeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypeRefsPackage.UNKNOWN_TYPE_REF__TYPE_NAME:
				return getTypeName();
		}
