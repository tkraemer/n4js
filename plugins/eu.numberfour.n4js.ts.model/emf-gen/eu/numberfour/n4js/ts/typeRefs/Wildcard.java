...
public interface Wildcard extends TypeArgument {
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return (((this.getDeclaredUpperBound() == null) && (this.getDeclaredLowerBound() == null)) && (!this.getDeclaredOrImplicitUpperBounds().isEmpty()));'"
	 * @generated
	 */
