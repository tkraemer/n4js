 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.StructuralTypeRef#getAstStructuralMembers <em>Ast Structural Members</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.StructuralTypeRef#getStructuralType <em>Structural Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.StructuralTypeRef#getGenStructuralMembers <em>Gen Structural Members</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.typeRefs.StructuralTypeRef#getPostponedSubstitutions <em>Postponed Substitutions</em>}</li>
 * </ul>
 *
 * @see eu.numberfour.n4js.ts.typeRefs.TypeRefsPackage#getStructuralTypeRef()
 * @model abstract="true"
 * @generated
 */
public interface StructuralTypeRef extends EObject {
	 ...
	 * The list contents are of type {@link eu.numberfour.n4js.ts.types.TStructMember}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see eu.numberfour.n4js.ts.typeRefs.TypeRefsPackage#getStructuralTypeRef_AstStructuralMembers()
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.ts.typeRefs.StructuralTypeRef#getStructuralType <em>Structural Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.numberfour.n4js.ts.typeRefs.TypeRefsPackage#getStructuralTypeRef_GenStructuralMembers()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link eu.numberfour.n4js.ts.typeRefs.TypeVariableMapping}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see eu.numberfour.n4js.ts.typeRefs.TypeRefsPackage#getStructuralTypeRef_PostponedSubstitutions()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipse.emf.common.util.EList%><<%eu.numberfour.n4js.ts.typeRefs.TypeVariableMapping%>> _postponedSubstitutions = this.getPostponedSubstitutions();\nfinal <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%eu.numberfour.n4js.ts.typeRefs.TypeVariableMapping%>, <%java.lang.Boolean%>> _function = new <%org.eclipse.xtext.xbase.lib.Functions.Function1%><<%eu.numberfour.n4js.ts.typeRefs.TypeVariableMapping%>, <%java.lang.Boolean%>>()\n{\n\tpublic <%java.lang.Boolean%> apply(final <%eu.numberfour.n4js.ts.typeRefs.TypeVariableMapping%> m)\n\t{\n\t\t<%eu.numberfour.n4js.ts.types.TypeVariable%> _typeVar = null;\n\t\tif (m!=null)\n\t\t{\n\t\t\t_typeVar=m.getTypeVar();\n\t\t}\n\t\treturn <%java.lang.Boolean%>.valueOf((_typeVar == typeVar));\n\t}\n};\nreturn <%org.eclipse.xtext.xbase.lib.IterableExtensions%>.<<%eu.numberfour.n4js.ts.typeRefs.TypeVariableMapping%>>exists(_postponedSubstitutions, _function);'"
	 * @generated
	 */
