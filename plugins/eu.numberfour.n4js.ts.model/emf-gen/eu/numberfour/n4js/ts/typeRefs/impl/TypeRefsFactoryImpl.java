...
public class TypeRefsFactoryImpl extends EFactoryImpl implements TypeRefsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TypeRefsPackage.CLASSIFIER_TYPE_REF: return createClassifierTypeRef();
	 ...
	 * @generated
	 */
	public ClassifierTypeRef createClassifierTypeRef() {
		ClassifierTypeRefImpl classifierTypeRef = new ClassifierTypeRefImpl();
	 ...
	 * @generated
	 */
	public EnumTypeRef createEnumTypeRef() {
		EnumTypeRefImpl enumTypeRef = new EnumTypeRefImpl();
		return enumTypeRef;
	}
