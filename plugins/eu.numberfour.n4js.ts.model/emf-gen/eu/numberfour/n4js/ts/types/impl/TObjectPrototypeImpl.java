 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.TObjectPrototypeImpl#getDeclaredTypeAccessModifier <em>Declared Type Access Modifier</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.TObjectPrototypeImpl#isDeclaredProvidedByRuntime <em>Declared Provided By Runtime</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.TObjectPrototypeImpl#getDeclaredElementType <em>Declared Element Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.TObjectPrototypeImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.TObjectPrototypeImpl#isDeclaredFinal <em>Declared Final</em>}</li>
 * </ul>
 *
 * @generated
 */
