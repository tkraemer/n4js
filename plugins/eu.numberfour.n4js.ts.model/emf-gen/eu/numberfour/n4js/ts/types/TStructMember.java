 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.types.TStructMember#getDefinedMember <em>Defined Member</em>}</li>
 * </ul>
 *
 * @see eu.numberfour.n4js.ts.types.TypesPackage#getTStructMember()
 * @model abstract="true"
 * @generated
 */
public interface TStructMember extends TMember {
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.ts.types.TStructMember#getDefinedMember <em>Defined Member</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return <%eu.numberfour.n4js.ts.types.MemberAccessModifier%>.PUBLIC;'"
	 * @generated
	 */
