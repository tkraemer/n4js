...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TStruct Member</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.TStructMemberImpl#getDefinedMember <em>Defined Member</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TStructMemberImpl extends TMemberImpl implements TStructMember {
		...
		if (definedMember != null && definedMember.eIsProxy()) {
			...
			if (definedMember != oldDefinedMember) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.TSTRUCT_MEMBER__DEFINED_MEMBER, oldDefinedMember, definedMember));
			}
		}
	...
	public void setDefinedMember(TStructMember newDefinedMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.TSTRUCT_MEMBER__DEFINED_MEMBER, oldDefinedMember, definedMember));
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == TMember.class) {
			switch (baseOperationID) {
				case TypesPackage.TMEMBER___GET_MEMBER_ACCESS_MODIFIER: return TypesPackage.TSTRUCT_MEMBER___GET_MEMBER_ACCESS_MODIFIER;
				case TypesPackage.TMEMBER___IS_STATIC: return TypesPackage.TSTRUCT_MEMBER___IS_STATIC;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TypesPackage.TSTRUCT_MEMBER___GET_DEFAULT_MEMBER_ACCESS_MODIFIER:
				return getDefaultMemberAccessModifier();
			case TypesPackage.TSTRUCT_MEMBER___IS_STATIC:
				return isStatic();
