 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.types.IdentifiableElement#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see eu.numberfour.n4js.ts.types.TypesPackage#getIdentifiableElement()
 * @model
 * @generated
 */
public interface IdentifiableElement extends TypableElement {
	 ...
	 * @see #setName(String)
	 * @see eu.numberfour.n4js.ts.types.TypesPackage#getIdentifiableElement_Name()
	 * @model unique="false"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.ts.types.IdentifiableElement#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return <%org.eclipse.xtext.EcoreUtil2%>.<<%eu.numberfour.n4js.ts.types.TModule%>>getContainerOfType(this, <%eu.numberfour.n4js.ts.types.TModule%>.class);'"
	 * @generated
	 */
