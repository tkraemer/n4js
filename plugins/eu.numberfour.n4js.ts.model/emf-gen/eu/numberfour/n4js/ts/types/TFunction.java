 ...
 *   <li>{@link eu.numberfour.n4js.ts.types.TFunction#isDeclaredGenerator <em>Declared Generator</em>}</li>
...
public interface TFunction extends DeclaredTypeWithAccessModifier, SyntaxRelatedTElement {
	 ...
	 * @see eu.numberfour.n4js.ts.types.TypesPackage#getTFunction_DeclaredGenerator()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.ts.types.TFunction#isDeclaredGenerator <em>Declared Generator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return (this.isReturnValueOptional_NEW_SYNTAX() || ((this.getReturnTypeRef() != null) && this.getReturnTypeRef().isFollowedByQuestionMark()));'"
	 * @generated
	 */
