...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Syntax Related TElement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.SyntaxRelatedTElementImpl#getAstElement <em>Ast Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SyntaxRelatedTElementImpl extends MinimalEObjectImpl.Container implements SyntaxRelatedTElement {
	 ...
	 * @generated
	 */
	protected SyntaxRelatedTElementImpl() {
		super();
	}
		...
		if (astElement != null && astElement.eIsProxy()) {
			...
			if (astElement != oldAstElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.SYNTAX_RELATED_TELEMENT__AST_ELEMENT, oldAstElement, astElement));
			}
		}
		return astElement;
	}
	...
	public void setAstElement(EObject newAstElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.SYNTAX_RELATED_TELEMENT__AST_ELEMENT, oldAstElement, astElement));
	}
