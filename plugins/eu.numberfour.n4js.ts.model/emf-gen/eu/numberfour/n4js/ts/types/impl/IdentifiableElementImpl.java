 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.ts.types.impl.IdentifiableElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifiableElementImpl extends ProxyResolvingEObjectImpl implements IdentifiableElement {
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.IDENTIFIABLE_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.IDENTIFIABLE_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.IDENTIFIABLE_ELEMENT__NAME:
				return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TypesPackage.IDENTIFIABLE_ELEMENT___GET_CONTAINING_MODULE:
