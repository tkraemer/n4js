...
public class SupportingRunnerPropertyTester extends PropertyTester {
	...
	public static final String PROPERTY_NAMESPACE = "eu.numberfour.n4jsx.runner.ui";
	/** property tested */
	...
	public SupportingRunnerPropertyTester() {
		...
		N4JSXActivator.getInstance().getInjector(N4JSXActivator.EU_NUMBERFOUR_N4JSX_N4JSX).injectMembers(this);
	}
