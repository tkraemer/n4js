...
import eu.numberfour.n4js.n4mf.resource.N4MFResourceDescriptionManager;
import eu.numberfour.n4js.n4mf.resource.N4MFResourceDescriptionStrategy;
import eu.numberfour.n4js.n4mf.utils.IPathProvider;
import eu.numberfour.n4js.n4mf.utils.RuntimePathProvider;
import eu.numberfour.n4js.n4mf.validation.N4MFIssueSeveritiesProvider;

/**
 * Use this class to register components to be used at runtime / without the Equinox extension registry.
 */
public class N4MFRuntimeModule extends eu.numberfour.n4js.n4mf.AbstractN4MFRuntimeModule {
	 ...
	 * eu.numberfour.n4js/n4mf/validation/messages.properties for a given issue code, when there is no other severity
