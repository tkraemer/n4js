...
import eu.numberfour.n4js.utils.emf.EObjectFeatureMerger;

/**
 * Singleton service class for merging the content of N4 manifests.
 */
@Singleton
public class ManifestMerger extends EObjectFeatureMerger {
	...
	public ProjectDescription mergeContent(final URI fromLocation, final URI toLocation) {
		...
		try {
			...
			LOGGER.error("Error while trying to merge N4 manifest content. Source URI: " + fromLocation
