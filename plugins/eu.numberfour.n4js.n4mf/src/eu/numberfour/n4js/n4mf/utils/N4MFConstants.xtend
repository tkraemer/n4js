 ...
 */
package eu.numberfour.n4js.n4mf.utils
...
abstract class N4MFConstants {
	...
	/**
	 * The extension of the N4 manifest file.
	 */
	public val static N4MF_FILE_EXTENSION = 'n4mf';

	/**
	 * The (raw) name of the N4 manifest file.
	 */
	public val static N4MF_FILE_NAME = 'manifest';

	/**
	 * The name (with extension) of the N4 manifest file.
	 */
