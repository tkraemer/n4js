 ...
 */
package eu.numberfour.n4js.common.unicode.generator
...
import static extension eu.numberfour.n4js.common.unicode.CharTypes.*
...
//			println(generateUnicodeRules)
	...
	new() throws IOException {
		Files.write(generateUnicodeRules, new File('grammar-gen/eu/numberfour/n4js/common/unicode/Unicode.xtext'), Charsets.UTF_8)
	}
	...
	def static generateUnicodeRules() '''
		...
		// eu.numberfour.n4js.common.unicode.generator.UnicodeGrammarGenerator
		//
		// Rather than editing this manually, update the generator instead!

		grammar eu.numberfour.n4js.common.unicode.Unicode
