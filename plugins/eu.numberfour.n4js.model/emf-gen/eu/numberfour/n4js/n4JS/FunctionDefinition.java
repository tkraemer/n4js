 ...
 * </ul>
 *
 * @see eu.numberfour.n4js.n4JS.N4JSPackage#getFunctionDefinition()
 * @model abstract="true"
 * @generated
 */
public interface FunctionDefinition extends FunctionOrFieldAccessor, TypeDefiningElement {
	 ...
	 * The list contents are of type {@link eu.numberfour.n4js.n4JS.FormalParameter}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.numberfour.n4js.n4JS.N4JSPackage#getFunctionDefinition_Fpars()
	 ...
	 * @see eu.numberfour.n4js.n4JS.N4JSPackage#getFunctionDefinition_ReturnTypeRef()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.n4JS.FunctionDefinition#getReturnTypeRef <em>Return Type Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.numberfour.n4js.n4JS.N4JSPackage#getFunctionDefinition_Generator()
	 * @model unique="false"
	 * @generated
	 */
	boolean isGenerator();
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.n4JS.FunctionDefinition#isGenerator <em>Generator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.numberfour.n4js.n4JS.N4JSPackage#getFunctionDefinition_DeclaredAsync()
	 * @model unique="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.n4JS.FunctionDefinition#isDeclaredAsync <em>Declared Async</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return ((((this.getDefinedFunction() != null) && this.getDefinedFunction().isReturnValueOptional()) || this.isReturnValueDeclaredOptional()) || ((this.getReturnTypeRef() != null) && this.getReturnTypeRef().isFollowedByQuestionMark()));'"
	 * @generated
	 */
