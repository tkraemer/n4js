 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.n4JS.TemplateSegment#getRawValue <em>Raw Value</em>}</li>
 * </ul>
 *
 * @see eu.numberfour.n4js.n4JS.N4JSPackage#getTemplateSegment()
 * @model
 * @generated
 */
public interface TemplateSegment extends Literal {
	 ...
	 * @see eu.numberfour.n4js.n4JS.N4JSPackage#getTemplateSegment_RawValue()
	 * @model unique="false"
	 * @generated
	 */
	String getRawValue();
	...
	/**
	 * Sets the value of the '{@link eu.numberfour.n4js.n4JS.TemplateSegment#getRawValue <em>Raw Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
