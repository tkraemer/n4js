 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.n4JS.impl.EqualityExpressionImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4JS.impl.EqualityExpressionImpl#getOp <em>Op</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4JS.impl.EqualityExpressionImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualityExpressionImpl extends ExpressionImpl implements EqualityExpression {
	 ...
	 * @ordered
	 */
	protected static final EqualityOperator OP_EDEFAULT = EqualityOperator.SAME;
	...
	protected EClass eStaticClass() {
		return N4JSPackage.Literals.EQUALITY_EXPRESSION;
	}
	...
	public void setLhs(Expression newLhs) {
		if (newLhs != lhs) {
			...
			if (lhs != null)
				msgs = ((InternalEObject)lhs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.EQUALITY_EXPRESSION__LHS, null, msgs);
			if (newLhs != null)
				msgs = ((InternalEObject)newLhs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.EQUALITY_EXPRESSION__LHS, null, msgs);
			msgs = basicSetLhs(newLhs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4JSPackage.EQUALITY_EXPRESSION__LHS, newLhs, newLhs));
	}
	...
	public void setRhs(Expression newRhs) {
		if (newRhs != rhs) {
			NotificationChain msgs = null;
			if (rhs != null)
				msgs = ((InternalEObject)rhs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.EQUALITY_EXPRESSION__RHS, null, msgs);
			if (newRhs != null)
				msgs = ((InternalEObject)newRhs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.EQUALITY_EXPRESSION__RHS, null, msgs);
			msgs = basicSetRhs(newRhs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4JSPackage.EQUALITY_EXPRESSION__RHS, newRhs, newRhs));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case N4JSPackage.EQUALITY_EXPRESSION__LHS:
				return basicSetLhs(null, msgs);
			case N4JSPackage.EQUALITY_EXPRESSION__RHS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case N4JSPackage.EQUALITY_EXPRESSION__LHS:
				return getLhs();
			case N4JSPackage.EQUALITY_EXPRESSION__OP:
				return getOp();
			case N4JSPackage.EQUALITY_EXPRESSION__RHS:
				return getRhs();
		}
