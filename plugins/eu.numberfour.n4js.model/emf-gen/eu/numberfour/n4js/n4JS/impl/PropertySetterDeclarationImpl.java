 ...
 * </p>
 * <ul>
 *   <li>{@link eu.numberfour.n4js.n4JS.impl.PropertySetterDeclarationImpl#getComputeNameFrom <em>Compute Name From</em>}</li>
 *   <li>{@link eu.numberfour.n4js.n4JS.impl.PropertySetterDeclarationImpl#getAnnotationList <em>Annotation List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertySetterDeclarationImpl extends SetterDeclarationImpl implements PropertySetterDeclaration {
	...
	public NotificationChain basicSetComputeNameFrom(Expression newComputeNameFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, N4JSPackage.PROPERTY_SETTER_DECLARATION__COMPUTE_NAME_FROM, oldComputeNameFrom, newComputeNameFrom);
	...
	public void setComputeNameFrom(Expression newComputeNameFrom) {
		if (newComputeNameFrom != computeNameFrom) {
			...
			if (computeNameFrom != null)
				msgs = ((InternalEObject)computeNameFrom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.PROPERTY_SETTER_DECLARATION__COMPUTE_NAME_FROM, null, msgs);
			if (newComputeNameFrom != null)
				msgs = ((InternalEObject)newComputeNameFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N4JSPackage.PROPERTY_SETTER_DECLARATION__COMPUTE_NAME_FROM, null, msgs);
			msgs = basicSetComputeNameFrom(newComputeNameFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, N4JSPackage.PROPERTY_SETTER_DECLARATION__COMPUTE_NAME_FROM, newComputeNameFrom, newComputeNameFrom));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case N4JSPackage.PROPERTY_SETTER_DECLARATION__COMPUTE_NAME_FROM:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PropertyAssignment.class) {
			switch (derivedFeatureID) {
				case N4JSPackage.PROPERTY_SETTER_DECLARATION__COMPUTE_NAME_FROM: return N4JSPackage.PROPERTY_ASSIGNMENT__COMPUTE_NAME_FROM;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PropertyAssignment.class) {
			switch (baseFeatureID) {
				case N4JSPackage.PROPERTY_ASSIGNMENT__COMPUTE_NAME_FROM: return N4JSPackage.PROPERTY_SETTER_DECLARATION__COMPUTE_NAME_FROM;
				default: return -1;
			}
		}
		if (baseClass == AnnotablePropertyAssignment.class) {
