 ...
 */
package eu.numberfour.n4js.tester.ui.resultsview;
...
import eu.numberfour.n4js.tester.domain.TestElement;
...
import eu.numberfour.n4js.tester.events.SessionFailedEvent;
import eu.numberfour.n4js.tester.events.SessionFinishedEvent;
import eu.numberfour.n4js.tester.events.SessionStartedEvent;
import eu.numberfour.n4js.tester.events.TestEndedEvent;
import eu.numberfour.n4js.tester.events.TestEvent;
import eu.numberfour.n4js.tester.events.TestStartedEvent;
import eu.numberfour.n4js.tester.ui.TesterFrontEndUI;
...
public class TestResultsView extends ViewPart {
	 ...
	 */
	public static final String ID = "eu.numberfour.n4js.tester.ui.TestResultsView";
