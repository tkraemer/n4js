(function(System) {
	'use strict';
	System.register([
		'eu.numberfour.mangelhaft/n4/mangel/mangeltypes/signal/Signal'
	], function($n4Export) {
		var Signal, TestSpy;
		TestSpy = function TestSpy() {
			this.testingStarted = new Signal();
			this.parameterizedGroupsStarted = new Signal();
			this.parameterizedGroupsFinished = new Signal();
		...
		return {
			setters: [
				function($_import_eu_u002enumberfour_u002emangelhaft_n4_u002fmangel_u002fmangeltypes_u002fsignal_u002fSignal) {
					Signal = $_import_eu_u002enumberfour_u002emangelhaft_n4_u002fmangel_u002fmangeltypes_u002fsignal_u002fSignal.Signal;
				}
			],
			execute: function() {
