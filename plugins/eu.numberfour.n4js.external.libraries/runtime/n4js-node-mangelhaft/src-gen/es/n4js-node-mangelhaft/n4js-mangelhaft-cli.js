...
(function() {
    ...
    if (execData) {
        ...
        lib_run.runWith({
            ...
            "test-mode": true,
            "main": "eu.numberfour.mangelhaft.runner.ide/n4/mangel/runner/ide/IDENodeTestRunner"
        }, true /* safeExit */);
    } else {
        lib_run.runWith({
            "test-mode": true,
            "main": "eu.numberfour.mangelhaft.runner.console/n4/mangel/runner/console/NodeConsoleTestRunner"
        });
    }
})();
