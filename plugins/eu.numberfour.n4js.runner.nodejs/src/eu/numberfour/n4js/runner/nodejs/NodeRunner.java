...
import eu.numberfour.n4js.runner.IRunner;
...
import eu.numberfour.n4js.runner.extension.RunnerDescriptorImpl;
...
public class NodeRunner implements IRunner {
	...
	public static final String ID = "eu.numberfour.n4js.runner.nodejs.NODEJS";
	...
	public Process run(RunConfiguration runConfig, IExecutor executor) {
		...
		try {
			...
			if (runConfig.isUseDefaultBootstrap()) {
				paths.add(DefaultBootstrap.getDefaultNodeEnvPath());
			}
