...
import static eu.numberfour.n4js.validation.IssueCodes.FUN_PARAM_IMPLICIT_DEFAULT_PARAM;
import static eu.numberfour.n4js.validation.IssueCodes.FUN_PARAM_INITIALIZER_ILLEGAL_FORWARD_REFERENCE;
import static eu.numberfour.n4js.validation.IssueCodes.FUN_PARAM_VARIADIC_ONLY_LAST;
import static eu.numberfour.n4js.validation.IssueCodes.FUN_PARAM_VARIADIC_WITH_INITIALIZER;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForFUN_PARAM_IMPLICIT_DEFAULT_PARAM;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForFUN_PARAM_INITIALIZER_ILLEGAL_FORWARD_REFERENCE;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForFUN_PARAM_VARIADIC_ONLY_LAST;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForFUN_PARAM_VARIADIC_WITH_INITIALIZER;
