...
import static eu.numberfour.n4js.ts.types.TypesPackage.Literals.IDENTIFIABLE_ELEMENT__NAME;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_CONFLICTS_WITH_CONSTRUCTOR;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_CONTAINS_DISCOURAGED_CHARACTER;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_DIFFERS_TYPE;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_DOES_NOT_START_LOWERCASE;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_DOES_NOT_START_UPPERCASE;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_DOLLAR;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_INDISTINGUISHABLE;
import static eu.numberfour.n4js.validation.IssueCodes.CLF_NAME_RESERVED;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_CONFLICTS_WITH_CONSTRUCTOR;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_CONTAINS_DISCOURAGED_CHARACTER;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_DIFFERS_TYPE;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_DOES_NOT_START_LOWERCASE;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_DOES_NOT_START_UPPERCASE;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_DOLLAR;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_INDISTINGUISHABLE;
import static eu.numberfour.n4js.validation.IssueCodes.getMessageForCLF_NAME_RESERVED;
import static eu.numberfour.n4js.validation.helper.N4JSLanguageConstants.ACCESS_MODIFIERS;
import static eu.numberfour.n4js.validation.helper.N4JSLanguageConstants.BASE_TYPES;
import static eu.numberfour.n4js.validation.helper.N4JSLanguageConstants.BOOLEAN_LITERALS;
