 ...
 * {@link eu.numberfour.n4js.parser.PropertyNameAwareElementFactory element factory} is used to keep track of the
 ...
 * {@link eu.numberfour.n4js.parser.antlr.internal.InternalN4JSParser#ruleReturnStatement() return statements},
 * {@link eu.numberfour.n4js.parser.antlr.internal.InternalN4JSParser#ruleContinueStatement() continue statements} and
 * {@link eu.numberfour.n4js.parser.antlr.internal.InternalN4JSParser#ruleBreakStatement() break statements} are
 ...
 * {@link eu.numberfour.n4js.n4JS.PostfixOperator}. At this location the line break is always treated as a semicolon
 * even though the operator may be validly consumed and produce a {@link eu.numberfour.n4js.n4JS.PostfixExpression}.
 * </p>
 *
 * <p>
 ...
 * explicit semicolons.
 *
 * <h3>Customizing in {@link eu.numberfour.n4js.parser.InternalSemicolonInjectingParser
 ...
 * {@link eu.numberfour.n4js.parser.InternalSemicolonInjectingParser#recover(org.antlr.runtime.IntStream, org.antlr.runtime.RecognitionException)
 * recovery strategy}.
 * </p>
 */
