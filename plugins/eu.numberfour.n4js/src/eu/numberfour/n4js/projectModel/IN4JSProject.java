...
public interface IN4JSProject extends IN4JSSourceContainerAware {
	...
	/**
	 * Returns with the URI of the N4 manifest file from the project. Optional, could return with an absent instance if
	 * the manifest file does not exist in the project. Never {@code null}.
	 *
	 * @return the URI of the N4 manifest file. Optional, may be missing but never {@code null}.
	 */
