...
import eu.numberfour.n4js.conversion.RegExLiteralConverter;
...
public class N4JSResource extends PostProcessingAwareResource implements ProxyResolvingResource {
	...
	public boolean loadFromDescription(IResourceDescription description) {
		...
		try {
			...
			// TODO: It is possible that TModule is null (e.g. if a module becomes invalid and thus ResourceDescriptWithoutUserData is created).
			// In that case, contents has an AST proxy without TModule. What is with this state??
			if (didLoadModule) {
