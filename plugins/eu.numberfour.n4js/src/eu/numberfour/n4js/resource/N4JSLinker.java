...
import eu.numberfour.n4js.conversion.AbstractN4JSStringValueConverter.BadEscapementException;
import eu.numberfour.n4js.conversion.N4JSValueConverterException;
import eu.numberfour.n4js.conversion.N4JSValueConverterWithValueException;
...
public class N4JSLinker extends LazyLinker {
	...
	protected void beforeModelLinked(EObject model, IDiagnosticConsumer diagnosticsConsumer) {
		...
		ComposedTypeMemberScope.clearCachedComposedMembers(model);
	}
