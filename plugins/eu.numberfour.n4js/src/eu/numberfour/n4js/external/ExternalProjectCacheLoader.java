...
import static eu.numberfour.n4js.external.N4JSExternalProject.BUILDER_ID;
import static eu.numberfour.n4js.external.N4JSExternalProject.NATURE_ID;
 ...
 * loader ensures that the {@link ProjectDescription project description} (N4 manifest) exists for the project.
 */
@Singleton
