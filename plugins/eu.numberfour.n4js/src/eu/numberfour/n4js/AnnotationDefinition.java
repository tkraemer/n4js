...
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.FUNCTION_DECLARATION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.FUNCTION_DEFINITION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.FUNCTION_OR_FIELD_ACCESSOR;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.INT_LITERAL;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_CLASSIFIER_DECLARATION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_CLASS_DECLARATION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_CLASS_DEFINITION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_FIELD_ACCESSOR;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_FIELD_DECLARATION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_INTERFACE_DECLARATION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_MEMBER_DECLARATION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_METHOD_DECLARATION;
import static eu.numberfour.n4js.n4JS.N4JSPackage.Literals.N4_SETTER_DECLARATION;
...
public final class AnnotationDefinition {
	 ...
	 * <p>
	 * A "raw" reference to the name is used in {@link eu.numberfour.n4js.n4JS.N4MethodDeclaration#isAbstract()} and
	 * {@link eu.numberfour.n4js.n4JS.N4FieldAccessor#isAbstract()}, as there must be no references from the model to
	 * n4js.
	 */
	...
	static class AnnotationDefinitionBuilder {
		...
		AnnotationDefinition end() {
			return new AnnotationDefinition(name, targets, targetsWithCustomError, transitive, repeatable, retention,
					argtypes,
					argsOptional, argsVariadic);
		}
	 ...
	 */
	private AnnotationDefinition(final String name, final EClass[] targets, final EClass[] targetsWithCustomError,
