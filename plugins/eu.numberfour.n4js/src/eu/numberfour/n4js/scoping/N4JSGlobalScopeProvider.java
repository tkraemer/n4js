 ...
 */
package eu.numberfour.n4js.scoping;
...
import eu.numberfour.n4js.scoping.accessModifiers.VisibilityAwareIdentifiableScope;
import eu.numberfour.n4js.scoping.accessModifiers.VisibilityAwareTypeScope;
import eu.numberfour.n4js.scoping.utils.UserDataAwareScope;
import eu.numberfour.n4js.ts.scoping.builtin.DefaultN4GlobalScopeProvider;
...
public class N4JSGlobalScopeProvider extends DefaultN4GlobalScopeProvider {
	 ...
	 * {@link eu.numberfour.n4js.projectModel.IN4JSProject#getDependencies()}.
	 */
	@Override
	protected IScope createContainerScopeWithContext(Resource resource, IScope parent, IContainer container,
		...
		if (resource != null) {
			...
			IScope result = UserDataAwareScope.createScope(parent, container, filter, type, ignoreCase,
					resource.getResourceSet(), container);
			return result;
		}
