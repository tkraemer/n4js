...
import eu.numberfour.n4js.scoping.accessModifiers.AbstractTypeVisibilityChecker
import eu.numberfour.n4js.scoping.accessModifiers.InvisibleTypeOrVariableDescription
import eu.numberfour.n4js.scoping.accessModifiers.TypeVisibilityChecker
import eu.numberfour.n4js.scoping.accessModifiers.VariableVisibilityChecker
...
import eu.numberfour.n4js.scoping.utils.LocallyKnownTypesScopingHelper
import eu.numberfour.n4js.scoping.utils.MergedScope
 ...
 * {@link N4JSScopeProvider#scope_IdentifierRef_id(eu.numberfour.n4js.n4JS.VariableEnvironmentElement) .scope_IdentifierRef_id()},
...
class ImportedElementsScopingHelper {
	...
	def IScope getImportedIdentifiables(IScope parentScope, Script script) {
		val IScope scriptScope = cache.get(script -> 'importedIdentifiables', script.eResource) [|
			...
			val builtInTypes = BuiltInTypeScope.get(script.eResource.resourceSet)
