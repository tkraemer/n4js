 ...
 */
class N4JSXGeneratorModule extends DefaultGeneratorModule {

	def configureXtextGeneratorNaming(Binder binder) {
		binder.bind(XtextGeneratorNaming).to(N4JSXGeneratorNaming)
	}
 ...
 */
class N4JSXGeneratorNaming extends XtextGeneratorNaming {
	...
	override getEclipsePluginActivator() {
		...
		if(pluginName === null) {
			...
			new TypeReference(pluginName + '.internal', 'N4JSXActivator')
		}
	}
}